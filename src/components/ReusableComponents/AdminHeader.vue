<template>
  <header class="sticky p-4 top-0 z-50 bg-white shadow">
            ...
            <ul class="flex space-x-6 lg:space-x-12 font-poppins">
              <li>
                <button 
                  ...
                  :class="['py-2 hover:text-green-600',
                    $route.name === 'AdminHome' ? 'text-green-600' : ''
                  ]">
                  Home
                </button>
              </li>
              <li>
                <button
                  ...
                  :class="[
                    ...
                    $route.name === 'Hardware' ? 'text-green-600 ' : ''
                  ]">                   
                  Hardware
                </button>
              </li>
              <li>
                <button 
                  ...
                  :class="[
                    'py-2 hover:text-green-600',
                    $route.name === 'UserManagement' ?'text-green-600 ' : '']">
                  Users
                </button>
              </li>
              <li>
                <button 
                  ...
                  :class="[
                    'py-2 hover:text-green-600',
                    $route.name === 'Monitoring' ? 'text-green-600' : '']">
            ...
            <ul class="flex flex-col space-y-4 font-poppins">
              <li>
                <button
                  ...
                  :class="{ 'text-green-600': $route.name === 'AdminProfile' }"
                >
              ...
              <li>
                <button
                  @click="navigateTo('AdminHome')"
                  class="flex items-center w-full gap-2 py-2 hover:text-green-600"
                  :class="{ 'text-green-600': $route.name === 'AdminHome' }"
                >
              ...
              <li>
                <button
                  @click="navigateTo('Hardware')"
                  class="flex items-center w-full gap-2 py-2 hover:text-green-600"
                  :class="{ 'text-green-600': $route.name === 'Hardware' }"
                >
                  <img class="w-4 h-4" src="/src/Images/icons/hardware.svg" alt="">
                  Hardware
                </button>
              </li>
              <li>
                <button
                  @click="navigateTo('UserManagement')"
                  class="flex items-center w-full gap-2 py-2 hover:text-green-600"
                  :class="{ 'text-green-600': $route.name === 'UserManagement' }"
                >
                  <img class="w-4 h-4" src="/src/Images/icons/greenusers.svg" alt="">
                  Users
                </button>
              </li>
              <li>
                <button
                  @click="navigateTo('Monitoring')"
                  class="flex items-center w-full gap-2 py-2 hover:text-green-600"
                  :class="{ 'text-green-600': $route.name === 'Monitoring' }"
                >
                  <img class="w-4 h-4" src="/src/Images/icons/monitoring.svg" alt="">
                  Monitoring
                </button>
              </li>
