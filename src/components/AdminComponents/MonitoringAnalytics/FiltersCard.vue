  ...
  <div class="grid m-4 h-full sm:m-5 lg:m-10 grid-cols-1 gap-6 font-poppins dark:bg-gray-900">
    ...
    <div class="bg-white dark:bg-gray-800 lg:h-[86.7%] rounded-lg shadow dark:shadow-gray-700 p-6 space-y-6">
      <div>
        ...
        <div class="space-y-4">
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Households</label>
            <select
              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 dark:text-gray-100">
      ...
      <div class="bg-gray-50 dark:bg-gray-700 rounded-md border border-gray-200 dark:border-gray-600 p-4">
        ...
        <div class="space-y-3 text-sm">
          <div class="flex justify-between">
            <span class="text-gray-600 dark:text-gray-300">Peak Usage</span>
            <span class="font-medium dark:text-gray-100">Sunday</span>
          </div>

          <div class="flex justify-between">
            <span class="text-gray-600 dark:text-gray-300">Low Usage</span>
            <span class="font-medium dark:text-gray-100">Tuesday</span>
          </div>
          ...
          <div class="flex justify-between pt-3 border-t border-gray-200 dark:border-gray-600">
            ...
            <span class="text-blue-600 dark:text-blue-400 font-bold">1,890 kWh</span>
          </div>
        </div>
